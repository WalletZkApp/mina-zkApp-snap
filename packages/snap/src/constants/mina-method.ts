export enum EMinaMethod {
    ...
    CREATE_NULLIFIER = 'mina_createNullifier',
    GET_PUBLIC_KEY = 'mina_getPublicKey',
    CALL_ZKAPPER = 'mina_zkApp',
    GENERATE_KEYPAIR = 'mina_generateKeypair',
    ACCOUNT_FAUCET = 'mina_faucetAccount',
  }
